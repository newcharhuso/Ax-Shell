...
DOCK_ALWAYS_OCCLUDED = config.get(
    "dock_always_occluded", DEFAULTS["dock_always_occluded"]
)
DOCK_ICON_SIZE = config.get("dock_icon_size", DEFAULTS["dock_icon_size"])
BAR_WORKSPACE_SHOW_NUMBER = config.get(
    "bar_workspace_show_number", DEFAULTS["bar_workspace_show_number"]
)
BAR_WORKSPACE_USE_CHINESE_NUMERALS = config.get(
    "bar_workspace_use_chinese_numerals", DEFAULTS["bar_workspace_use_chinese_numerals"]
)
BAR_HIDE_SPECIAL_WORKSPACE = config.get(
    "bar_hide_special_workspace", DEFAULTS["bar_hide_special_workspace"]
)
...
BAR_COMPONENTS_VISIBILITY = {
    "button_apps": config.get(
        "bar_button_apps_visible", DEFAULTS["bar_button_apps_visible"]
    ),
    ...
    "button_tools": config.get(
        "bar_button_tools_visible", DEFAULTS["bar_button_tools_visible"]
    ),
    "sysprofiles": config.get(
        "bar_sysprofiles_visible", DEFAULTS["bar_sysprofiles_visible"]
    ),
    "button_overview": config.get(
        "bar_button_overview_visible", DEFAULTS["bar_button_overview_visible"]
    ),
    "ws_container": config.get(
        "bar_ws_container_visible", DEFAULTS["bar_ws_container_visible"]
    ),
    ...
    "button_power": config.get(
        "bar_button_power_visible", DEFAULTS["bar_button_power_visible"]
    ),
}
...
METRICS_SMALL_VISIBLE = config.get(
    "metrics_small_visible", DEFAULTS["metrics_small_visible"]
)
